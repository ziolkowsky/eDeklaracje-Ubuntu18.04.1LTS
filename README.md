...
```
### Niespełnione zależności epizod 1
```
...
```
sudo apt-get install libbz2-1.0:i386 libc6:i386 libgtk2.0-0:i386 libnss3:i386 libstdc++6:i386 libxml2:i386 libxaw7:i386 libxslt1.1:i386
```
### Niespełnione zależności epizod 2 
```
...
```
### Niespełnione zależności epizod 4
```
Reading package lists... Done
Building dependency tree 
Reading state information... Done
...
```
### Niespełnione zależności epizod 5
```
Reading package lists... Done
Building dependency tree 
Reading state information... Done
...
```
### Niespełnione zależności epizod 6
```
Reading package lists... Done
Building dependency tree 
Reading state information... Done
...
Preparing to unpack adobe-air_amd64.deb ...
Unpacking adobeair (1:2.6.0.2) over (1:2.6.0.2) ...
...
### Instalacja
```
sudo /usr/bin/Adobe\ AIR\ Application\ Installer ~/Downloads/e-DeklaracjeDesktop.air
``` 
### Błąd instalacji
```
Adobe AIR application could not be installed. Debian tools for creating deb packages (such as dpkg-deb or ar) were not found on the system.
```
